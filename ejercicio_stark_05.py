...
while True:
    ...
    match menu:
        ...
        case 3:
            ...
            superheroes_leidos=leer_csv(lista_csv_altura_ascendente)
        ...
        case 5:
            ...
            superheroes_leidos = leer_json(lista_json_peso_descendente, "Heroes_peso_descendentes")
            if superheroes_leidos:
                print("Lista de superhéroes leída:")
                for heroe in superheroes_leidos:
                    print(heroe)
            else:
                print("No se pudo leer la lista de superhéroes.")
        case 6:
